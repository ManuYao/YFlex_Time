export const getTokens = (mode) => {
  if (mode === 'dark') {
    return {
      ...
      // Découpes de phase sur la barre de progression : la couleur inverse du
      // texte, pour rester lisible aussi bien sur la partie remplie (primary)
      // que sur la partie vide (ringInactive).
      trackNotch: 'rgba(255,255,255,0.55)',
    };
  }
  return {
    primary: '#FFFFFF',
