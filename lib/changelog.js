...
export const CHANGELOG_HISTORY = [
  {
    ...
    date: '24 sept. 2026',
    summary:
      "Un coach vocal peut t'annoncer la séance à voix haute : court et tranché (« 3 sur 8 ») ou motivant, voix femme ou homme.",
    items: [
      {
        icon: '🗣️',
      ...
      {
        icon: '🎚️',
        text: "« Personnaliser le coach » ouvre sa fenêtre de réglages. Style Essentiel par défaut, l'info tranchée en une ou deux secondes (« 3 sur 8. », « Repos. 30 secondes. »), ou style Motivant, avec des phrases de coach qui t'encouragent. Touche un choix pour l'écouter.",
      },
      {
        icon: '🚻',
