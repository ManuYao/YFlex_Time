...
export const CHANGELOG_BACKLOG = [
  {
    ...
    items: [
      {
        icon: 'share',
        text: "Nouveau : partage un MIX avec un pote — bouton « Partager » dans le Constructeur (et sur chaque mix de « Mes mix »), un lien envoyé par SMS/WhatsApp/Instagram. La personne voit un aperçu du mix (nom, blocs, durée) avant de l'ajouter à sa propre bibliothèque.",
      },
      {
        icon: 'list',
