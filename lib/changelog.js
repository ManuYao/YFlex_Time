...
export const CHANGELOG_BACKLOG = [
  {
    ...
    items: [
      {
        icon: 'share',
        text: "Nouveau : partage un MIX avec un pote — bouton « Partager » dans le Constructeur (et sur chaque mix de « Mes mix »). Une fenêtre montre d'abord un aperçu de ce qui va être envoyé, puis un lien part par SMS/WhatsApp/Instagram.",
      },
      {
        icon: 'link',
        text: "Reçu un mix mais le lien n'est pas cliquable (ça arrive avec certaines apps de messagerie) ? Colle-le directement dans la même fenêtre « Partager » : un aperçu s'affiche avant de l'ajouter à ta bibliothèque.",
      },
      {
        icon: 'list',
        text: "Planning : possibilité d'écrire une note libre pour chaque jour (ex. « forme moyenne, bien dormi »), juste sous le titre du jour.",
      },
    ],
  },
  {
