...
export const CHANGELOG_HISTORY = [
  {
    ...
    items: [
      ...
      {
        icon: '🚻',
        text: "Choix de la voix (homme/femme) une fois le coach activé, avec des phrases de coach variées et énergiques. Pendant le repos, la voix t'aide à récupérer puis à te préparer (« Dix secondes, prépare-toi ! »).",
      },
      {
        icon: '🎧',
