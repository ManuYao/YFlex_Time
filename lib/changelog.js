...
export const CHANGELOG_HISTORY = [
  {
    ...
    items: [
      ...
      {
        icon: '🌗',
        text: "Pendant une séance, le fond s'assombrit doucement le temps du repos entre les séries, et se rallume quand le travail reprend. Chaque mode garde sa couleur : c'est la sienne qui baisse d'intensité, pas une autre qui la remplace.",
      },
      {
        icon: '🔄',
