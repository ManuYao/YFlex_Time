...
export const CHANGELOG_HISTORY = [
  {
    ...
    date: '24 sept. 2026',
    summary:
      "Un coach vocal peut annoncer les phases et les tours à voix haute pendant la séance (réglage Paramètres, désactivé par défaut).",
    items: [
      {
        icon: '🗣️',
        text: "Nouveau réglage « Voix du coach » (Paramètres > Audio et haptique, désactivé par défaut) : une voix annonce « Go », « Repos », le dernier tour, la moitié de la séance, les dix dernières secondes...",
      },
      {
        icon: '🔇',
