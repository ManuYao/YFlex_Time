...
export async function updateTimerNotification({
  ...
  actions.push({ title: 'Stop', pressAction: { id: TIMER_ACTIONS.STOP } });
  ...
  try {
    await notifee.displayNotification({
      ...
      android: {
        ...
        // Fond du système (sombre en thème sombre) + accents à la couleur du
        // mode (icône, nom de l'app, barre, boutons) plutôt qu'une notif
        // entièrement colorée : plus lisible, plus proche de l'écran Running.
        color,
        colorized: false,
        progress,
        visibility: AndroidVisibility.PUBLIC,
